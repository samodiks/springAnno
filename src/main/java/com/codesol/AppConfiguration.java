    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.codesol");
                servletContext.setInitParameter("tapestry.development-modules", "com.codesol.services.DevelopmentModule");
